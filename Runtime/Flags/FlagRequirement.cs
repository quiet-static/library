...
namespace QuietStatic.Toolkit.Flags
{
    ...
    public enum FlagRequirementMode
    {
        ...
        /// <summary>
        /// Every configured flag id must be set in the target <see cref="FlagSet"/>.
        /// </summary>
        All,

        /// <summary>
        /// At least one configured flag id must be set in the target <see cref="FlagSet"/>.
        /// </summary>
        Any,
    ...
    public class FlagRequirement
    {
        ...
        [Tooltip("Flag ids checked by this requirement. These should match ids stored in the active FlagSet.")]
        ...
        /// <c>true</c>. All other modes require a valid <see cref="FlagSet"/> instance.
        /// </remarks>
        public bool IsMet(FlagSet flagSet = null)
        {
