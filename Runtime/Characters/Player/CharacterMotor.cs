...
namespace QuietStatic.Toolkit.Characters.Player
{
    ...
    public class CharacterMotor : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("Optional camera transform used to make movement camera-relative.")]
        [SerializeField] private Transform cameraTransform;

        /// <summary>
        /// Optional movement state controller that will be updated after motor processing.
        /// </summary>
        [Tooltip("Optional state controller updated with grounded and movement results.")]
        ...
        /// </summary>
        [Tooltip("Downward acceleration applied while airborne. Use a negative value.")]
        [SerializeField] private float gravity = -9.81f;

        /// <summary>
        /// Small downward velocity applied while grounded to keep the controller anchored.
        /// </summary>
        [Tooltip("Small negative velocity that keeps the CharacterController grounded.")]
        ...
        /// </summary>
        [Tooltip("Write CharacterMotor diagnostic messages through GameLogger.")]
